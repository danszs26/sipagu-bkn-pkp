                        ...
                        @forelse ($komponenList as $k)
                            <tr>
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <form action="{{ route('settings.master-komponen.destroy', $k) }}" method="POST" class="inline" onsubmit="return confirm('Hapus komponen {{ $k->kode }}? Tindakan ini tidak bisa dibatalkan.')">
                                        @csrf @method('DELETE')
